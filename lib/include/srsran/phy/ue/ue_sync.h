...
typedef struct SRSRAN_API {
  ...
  int decimate;
  void *stream;
  void *stream_a; // for multiple USRP
  void *stream_b; // for multiple USRP
  void *stream_single;
  int (*recv_callback)(void*, cf_t* [SRSRAN_MAX_CHANNELS], uint32_t, srsran_timestamp_t*);
  int (*recv_callback_multi)(void*,void*, cf_t* [SRSRAN_MAX_CHANNELS], cf_t* [SRSRAN_MAX_CHANNELS], uint32_t, srsran_timestamp_t*); // for multiple USRP
...
SRSRAN_API int srsran_ue_sync_init_multi_usrp(srsran_ue_sync_t* q,
                                              uint32_t          max_prb,
                                              bool              search_cell,
...
SRSRAN_API int srsran_ue_sync_init_multi_usrp_decim_mode(srsran_ue_sync_t* q,
                                                        uint32_t          max_prb,
                                                        bool              search_cell,
                                                        int(recv_callback_multi)(void*, void*, cf_t* [SRSRAN_MAX_CHANNELS], cf_t* [SRSRAN_MAX_CHANNELS], uint32_t, srsran_timestamp_t*),
                                                        int(recv_callback)(void*, cf_t* [SRSRAN_MAX_CHANNELS], uint32_t, srsran_timestamp_t*),
...
SRSRAN_API int
srsran_ue_sync_zerocopy_multi_usrp(srsran_ue_sync_t* q, cf_t* input_buffer_a[SRSRAN_MAX_CHANNELS], cf_t* input_buffer_b[SRSRAN_MAX_CHANNELS], const uint32_t max_num_samples);                                              

SRSRAN_API int srsran_ue_sync_run_track_pss_mode_multi_usrp(srsran_ue_sync_t* q, 
                                                            cf_t* input_buffer_a[SRSRAN_MAX_CHANNELS], 
                                                            cf_t* input_buffer_b[SRSRAN_MAX_CHANNELS]);

SRSRAN_API int srsran_ue_sync_run_find_pss_mode_multi_usrp(srsran_ue_sync_t* q, 
                                                            cf_t* input_buffer_a[SRSRAN_MAX_CHANNELS], 
                                                            cf_t* input_buffer_b[SRSRAN_MAX_CHANNELS]);
