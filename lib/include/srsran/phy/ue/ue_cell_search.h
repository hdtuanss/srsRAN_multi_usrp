...
typedef struct SRSRAN_API {
  ...
  cf_t*    sf_buffer_b[SRSRAN_MAX_CHANNELS];
...
SRSRAN_API int
srsran_ue_cellsearch_scan_N_id_2_multi_usrp(srsran_ue_cellsearch_t* q, uint32_t N_id_2, srsran_ue_cellsearch_result_t* found_cell);

SRSRAN_API int srsran_ue_cellsearch_scan_multi_usrp(srsran_ue_cellsearch_t*       q,
                                                    srsran_ue_cellsearch_result_t found_cells[3],
                                                    uint32_t*                     max_N_id_2);
